...
import { Plus, Trash2, Search, Package, Truck, ShoppingBag } from 'lucide-react';
        ...
        <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto" data-testid="purchase-dialog">
          ...
          <form onSubmit={handleSubmit}>
                ...
                {selectedSupplier ? (
                  <div className="flex items-center justify-between p-3 bg-accent/30 rounded-md">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">{selectedSupplier.contact_name || 'Sin contacto'}</p>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <Input
                      placeholder="Buscar proveedor por nombre... (mínimo 2 caracteres)"
                        ...
                        <TableBody>
                          {items.map((item) => (
                            <TableRow key={item.barcode}>
                                ...
                                <input
                                  ...
                                  onBlur={(e) => {
                                    if (!e.target.value || parseInt(e.target.value) <= 0) {
                                      setItemQuantity(item.barcode, 1);
                                    }
                                  }}
                              ...
                              <TableCell>
                                <div className="flex items-center justify-center gap-1">
                                  ...
                                  <input
                                    ...
                                    onBlur={(e) => {
                                      if (!e.target.value) updateItemField(item.barcode, 'unit_cost', 0);
                                    }}
                              ...
                              <TableCell>
                                <Button type="button" variant="ghost" size="icon" className="h-8 w-8 text-destructive hover:text-destructive" onClick={() => removeItem(item.barcode)} data-testid={`remove-item-${item.barcode}`}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={!selectedSupplier || items.length === 0} data-testid="save-purchase-button">Registrar Compra</Button>
            </DialogFooter>
          </form>
        </DialogContent>
      </Dialog>
